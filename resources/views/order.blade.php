...
<body class="antialiased bg-gradient-to-br from-primary-light/10 to-white dark:from-primary-dark dark:to-gray-900 min-h-screen">
  ...
  <main class="container mx-auto px-6 py-12" id="top">
    ...
    <div class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 mb-8 max-w-5xl mx-auto" role="alert">
      ...
      <div class="mt-4 bg-white/50 p-4 rounded-lg border border-yellow-200">
        <p class="font-bold text-yellow-800">Contoh Simulasi Pemesanan:</p>
        <p class="mt-2">
          Ayah dan Bunda akan melaksanakan aqiqah anak perempuan, dengan jumlah kebutuhan kotakan sebanyak 140 kotak.
          Kambing yang dipilih adalah kambing jantan dan paket kotakan yang dipilih adalah PAKET PRAKTIS 3.
        </p>
        <div class="mt-2 pl-4 border-l-2 border-yellow-300">
          <p><b>Pilihan kambing yang memenuhi:</b></p>
          <ul class="list-disc pl-5">
            <li>TIPE ISTIMEWA (140 Porsi)</li>
            <li>Harga kambing jantan: Rp 3.630.000</li>
          </ul>
          <p class="mt-2"><b>Perhitungan:</b></p>
          <ul class="list-disc pl-5">
            <li>Jumlah kotakan: 140 Kotak × Rp 20.000 = Rp 2.800.000</li>
            <li>Total Pemesanan: Rp 3.630.000 + Rp 2.800.000 = <span class="font-bold">Rp 6.430.000</span></li>
          </ul>
        </div>
      </div>
    </div>

    <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md max-w-5xl mx-auto">
  ...
  <div class="loading-overlay" id="loadingOverlay">
    <div class="loading-content">
      ...
      <h2 class="text-xl font-bold mb-2">Memproses Pesanan</h2>
